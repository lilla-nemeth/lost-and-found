...
const Navbar = (props) => {
		...
		return (
			<>
				<li className='navList'>
					<Link className={className} to='/' onClick={() => setHamburgerOpen(!hamburgerOpen)}>
						Lost & Found
					</Link>
				</li>
	...
	function returnProtectedLinks(className, buttonClassName) {
		return (
			<>
				...
				<li>
					<Link className={className} to='/reportpet' onClick={() => setHamburgerOpen(!hamburgerOpen)}>
						Report Pet
					</Link>
				</li>
				<li>
					<Link className={className} to='/dashboard' onClick={() => setHamburgerOpen(!hamburgerOpen)}>
						Dashboard
					</Link>
				</li>
				<li>
	...
	function handleNavbarStatus(isOpen, setNavDesktop, setNavMobile, navStyle, logOutStyle) {
		if (isOpen) {
			return (
				<>
